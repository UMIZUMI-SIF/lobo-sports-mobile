...
class AndroidSmallSevenScreen extends GetWidget<AndroidSmallSevenController> {
  const AndroidSmallSevenScreen({Key? key})
      : super(
          key: key,
        );
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          "lbl_short_de_azul".tr,
                          style: theme.textTheme.bodyMedium,
                        ),
                        Text(
                          "msg_camiseta_entrenar".tr,
                          style: theme.textTheme.bodyMedium,
                        ),
                      ],
                    ),
      ...
      child: Stack(
        ...
        children: [
          Align(
            alignment: Alignment.topLeft,
            child: Padding(
              padding: EdgeInsets.fromLTRB(17.h, 141.v, 37.h, 153.v),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(
